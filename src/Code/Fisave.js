      ...
      <div className="App-details">
        ...
        <div className="description-app">
          <div className="second-description-app">
            <h3>Project Notes</h3>
            <p>
              As a former stock broker & finance manager, I am passionate about
              empowering people to manage their money with confidence.
              <br />
              <br />
              This full stack project helps users track their networth over
              time. I developed protected endpoints to handle HTTP requests from
              the client to prevent unauthorized access to user’s finances.
            </p>
            <section>
              <a
