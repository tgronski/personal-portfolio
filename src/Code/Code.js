      ...
      <section className="projects">
        <span className="Home-title">
          ...
          <span className="Home-nav">
            <button className="Home-button" onClick={() => this.handleAll()}>
              All
            </button>
            <button
              className="Home-button"
              onClick={() => this.handleFullStack()}
            >
              Full Stack
            </button>
            <button className="Home-button" onClick={() => this.handleD3()}>
              D3.js
            </button>
            <button className="Home-button" onClick={() => this.handleJQuery()}>
              jQuery
            </button>
          </span>
          <br />
