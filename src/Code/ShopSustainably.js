    ...
    return (
      <div className="App-details">
        <h2 className="title-app">
          Shop Sustainably: A Database of Sustainable Stores
        </h2>
        ...
        <div className="description-app">
          <div className="second-description-app">
            ...
            <p>
              {" "}
              There are so many ways to shop more sustainably, but sometimes it
              can be hard to find the right resources. This full stack project
              helps users find sustainable stores in a variety of categories all
              in one database. <br /> <br /> The PostgreSQL data is stored on
